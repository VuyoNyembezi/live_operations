defmodule LiveOperationsWeb.EventLive.Active do
 ...
 alias LiveOperations.Sport
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, assign(socket, :active, live_fixtures())}
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    ...
    {:noreply, assign(socket, :fixtures, live_fixtures())}
  end
  ...
  # definitions modules
    ...
    fixture_data = Events.live_fixtures()
