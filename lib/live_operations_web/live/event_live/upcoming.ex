defmodule LiveOperationsWeb.EventLive.Upcoming do
 ...
 alias LiveOperations.Sport
  ...
  def mount(_params, _session, socket) do
    ...
    {:ok, assign(socket, :upcoming, upcoming_fixtures())}
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    ...
    {:noreply, assign(socket, :fixtures, upcoming_fixtures())}
  end
  ...
  # definitions modules
    ...
    fixture_data = Events.upcoming_fixtures()
